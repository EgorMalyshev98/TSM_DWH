...
{% if is_incremental() %}
    ...
    stage_block_hashes AS (
        SELECT
            ...
            loadts,
            COUNT(*)                                                                AS stg_count,
            string_agg(hdiff_dv_msat_fact_pikets::varchar, ',' ORDER BY hdiff_dv_msat_fact_pikets)            AS stg_block_hash
        FROM stage_raw
    ...
    stage_with_seq AS (
        SELECT
            ...
            hdiff_dv_msat_fact_pikets      AS stg_hdiff,
            ...
            row_number() OVER (
                ...
                ORDER BY hdiff_dv_msat_fact_pikets
            ) AS sub_seq,
            stg_count,
            stg_block_hash,
            ключстроки,
